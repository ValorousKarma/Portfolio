...
const text = `
I've followed my interest in computers my entire life. Now, 
as a recent college grad I am looking for work in the areas of 
cybersecurity and software engineering. Take a look through 
my portfolio to see what I have accomplished during the past 
several years.
`;
...
const RenderText = () => {
	return (
		<>
			<h2 className={`${styles.sectionHeadText} text-center my-16`}>
				My Passions.
			</h2>
			<p
